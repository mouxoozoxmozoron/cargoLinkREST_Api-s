                                             ...
                                             <tr>
                                                 <td>
                                                     <div class="col-md-4">
                                                         ...
                                                         <img src="{{ asset('storage/' . $companyorder->cargo_image) }}"
                                                             class="img-fluid rounded-start" alt="N/A">
                                                     </div>
                                                 </td>
                                                 <td>
                                                     <h6 class="mb-1">kg/countable</h6>
                                                     <span class="text-secondary fs-7">{{ $companyorder->quantity }}
                                                     </span>
                                                 </td>
                                                 <td>
                                                     <h6 class="mb-1">To</h6>
                                                 ...
                                                 {{-- order actions --}}
                                                 <td>
                                                     @if ($companyorder->position == 0 && $companyorder->status == 1)
                                                         <a href="{{ route('dashboard.companyorder.deliver', ['id' => $companyorder->id]) }}"
                                                             class="btn btn-success btn-deliver">Delivered</a>
                                                     @endif
                                                     <a href="{{ route('dashboard.companyorder.delete', ['id' => $companyorder->id]) }}"
